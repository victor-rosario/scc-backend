...
export class UpdateRequestView1702388429528 implements MigrationInterface {
    name = 'UpdateRequestView1702388429528'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DELETE FROM "public"."typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["VIEW","request-view","public"]);
        await queryRunner.query(`DROP VIEW "request-view"`);
        await queryRunner.query(`CREATE VIEW "request-view" AS SELECT r.id,
    r.uuid,
    r."createdAt",
    r."updatedAt",
    r."deletedAt",
